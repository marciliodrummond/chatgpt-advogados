...
const synonyms: Record<string, string[]> = {
  ...
  'blindagem': ['blindagem', 'anti alucinacao', 'verificacao', 'protecao', 'conferir', 'prompt protection'],

  // GPTs avançados (Playbook Elite)
  'persona': ['persona', 'utopica', 'identidade', 'perfil', 'personalidade', 'gpt', 'criar'],
  'persona utopica': ['persona', 'utopica', 'elite', 'identidade', 'perfil', 'gpt'],
  'utopica': ['utopica', 'persona', 'elite', 'identidade', 'gpt', 'criar'],
  'rag': ['rag', 'knowledge base', 'documentos', 'base conhecimento', 'upload', 'arquivo'],
  'knowledge base': ['knowledge base', 'rag', 'documentos', 'base', 'upload', 'gpt'],
  'base de conhecimento': ['knowledge base', 'rag', 'documentos', 'upload', 'gpt'],
  'blindar gpt': ['blindagem', 'protecao', 'instrucoes', 'prompt protection', 'extrair'],
  'prompt protection': ['prompt protection', 'blindagem', 'protecao', 'instrucoes', 'revelar'],
  'meta assistente': ['meta assistente', 'auxiliar', 'gpt', 'criar', 'avaliador', 'gerador'],
  'auxiliar': ['auxiliar', 'meta assistente', 'gpt', 'criar', 'avaliador'],
  'setor': ['setor', 'comercial', 'operacoes', 'administrativo', 'departamento', 'equipe'],
  'elementos gpt': ['elementos', 'framework', 'gpt', 'construir', 'criar', 'instrucoes'],
  'criar gpt': ['criar', 'gpt', 'personalizado', 'instructions', 'custom', 'construir'],
  'instructions': ['instructions', 'instrucoes', 'gpt', 'configurar', 'persona'],
  'ocr': ['ocr', 'escaneado', 'pdf', 'rag', 'knowledge base', 'documento'],
  'sentinela': ['sentinela', 'teste', 'rag', 'knowledge base', 'validar'],
...
const intentMap: Record<string, string[]> = {
  ...
  // GPTs avançados (Playbook Elite)
  'persona utopica': ['Persona Utopica', 'Os 10 Elementos do GPT Perfeito'],
  'criar persona': ['Persona Utopica', 'GPTs Auxiliares'],
  'como criar gpt': ['Os 10 Elementos do GPT Perfeito', 'Criando GPTs Personalizados', 'Persona Utopica'],
  'gpt perfeito': ['Os 10 Elementos do GPT Perfeito', 'Persona Utopica'],
  'knowledge base gpt': ['Knowledge Base RAG para GPTs Juridicos'],
  'rag juridico': ['Knowledge Base RAG para GPTs Juridicos'],
  'documentos gpt': ['Knowledge Base RAG para GPTs Juridicos'],
  'proteger instrucoes': ['Blindagem de Instrucoes'],
  'blindar instrucoes': ['Blindagem de Instrucoes'],
  'prompt injection': ['Blindagem de Instrucoes'],
  'gpt auxiliar': ['GPTs Auxiliares Meta Assistentes'],
  'meta assistente': ['GPTs Auxiliares Meta Assistentes'],
  'avaliador gpt': ['GPTs Auxiliares Meta Assistentes'],
  'gpt por setor': ['GPTs por Setor'],
  'equipe ia': ['GPTs por Setor'],
  'departamento gpt': ['GPTs por Setor'],
  'gpt comercial': ['GPTs por Setor'],
  'gpt administrativo': ['GPTs por Setor'],
  'gpt operacoes': ['GPTs por Setor'],
...
const relatedMap: Record<string, string[]> = {
  ...
  'Persona Utópica: O Método Elite para GPTs': ['Os 10 Elementos do GPT Perfeito', 'GPTs Auxiliares: Meta-Assistentes de IA', 'Criando GPTs Personalizados'],
  'Os 10 Elementos do GPT Perfeito': ['Persona Utópica: O Método Elite para GPTs', 'Knowledge Base (RAG) para GPTs Jurídicos', 'Blindagem de Instruções: Protegendo seus GPTs'],
  'Knowledge Base (RAG) para GPTs Jurídicos': ['Os 10 Elementos do GPT Perfeito', 'Blindagem de Instruções: Protegendo seus GPTs', 'Criando GPTs Personalizados'],
  'Blindagem de Instruções: Protegendo seus GPTs': ['Os 10 Elementos do GPT Perfeito', 'Knowledge Base (RAG) para GPTs Jurídicos'],
